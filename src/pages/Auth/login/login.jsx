    ...
    <main className="min-h-screen text-primary-white">
      <div className="max-w-7xl mx-auto min-h-screen p-0">
        ...
        <div className="bg-pink-panther-300 w-115 p-6 rounded-3xl flex flex-col items-center">
            ...
            <label htmlFor="username" className="text-dark text-lg mb-1">
                Usuario
            </label>
            <input
                type="text"
            ...
            {/* Botones adicionales */}
            <Link to="/register" className="mt-4 w-80 text-center p-2 border border-gray-900 rounded-md hover:bg-gray-200 transition">
            Registrarse
            </Link>
