  ...
  return (
    <main className="graphic-container max-w-7xl mx-auto p-0 mt-6">
      <section className='p-4 md:p-10 bg-green-200 mt-6 rounded-2xl'>
        ...
        <div className='p-4 md:p-10 flex flex-col max-w-7xl mx-auto'>
          <div className="content-flex">
            <div className="content">
              <div className="content-graphic">
                <div>
                  <p className='text-2xl md:text-3xl'>🖼 <strong className='text-2xl md:text-3xl'>Edición y retoque fotográfico (Affinity Photo)</strong></p>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>📐 <strong className='text-2xl md:text-3xl'>Diseño vectorial (Affinity Designer)</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>📚 <strong className='text-2xl md:text-3xl'>Diseño editorial (Affinity Publisher)</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
