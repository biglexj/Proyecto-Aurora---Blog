          ...
          <div className="content-flex">
            <div className="content">
              <div className="content-karaoke">
                <div>
                  <p className='text-2xl md:text-3xl'>🎶 <strong className='text-2xl md:text-3xl'>Pistas con letras sincronizadas (SRT o LRC)</strong></p>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>🎤 <strong className='text-2xl md:text-3xl'>Karaokes con letras sincronizadas (SRT o LRC)</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>🔀 <strong className='text-2xl md:text-3xl'>Mix de pistas</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
