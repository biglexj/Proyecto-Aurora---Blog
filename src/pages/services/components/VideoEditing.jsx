          ...
          <div className="content-flex">
            <div className="content">
              <div className="content-video">
                <div>
                  <p className='text-2xl md:text-3xl'>🎥 <strong className='text-2xl md:text-3xl'>Edición personalizada</strong></p>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>🔀 <strong className='text-2xl md:text-3xl'>Videos verticales para redes sociales</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
                ...
                <div className='mt-5'>
                  <p className='text-2xl md:text-3xl'>🎞 <strong className='text-2xl md:text-3xl'>Servicios adicionales destacado</strong></p>
                  <ul className='text-lg md:text-xl font-medium'>
